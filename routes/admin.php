...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    */
    ...
    Route::get('/admin/reports/trend-incident-by-daily/list', 'Admin\ReportsController@getTrendIncidentByDaily')->where('id', '[0-9]+')->name('admin.reports.trend-incident-by-daily.list');
    Route::get('/admin/reports/donut-report-by-daily/list', 'Admin\ReportsController@getDonutReportByDaily')->name('admin.reports.donut-by-daily.list');
    Route::get('/admin/reports/donut-report-by-daily-answer/list', 'Admin\ReportsController@getDonutReportByDailyAnswer')->name('admin.reports.donut-by-daily-answer.list');

    Route::get('/admin/reports/trend-report-by-daily-all/list', 'Admin\ReportsController@getTrendReportByDailyAll')->where('id', '[0-9]+')->name('admin.reports.trend-report-by-daily-all.list');
    Route::get('/admin/reports/trend-incident-by-daily-all/list', 'Admin\ReportsController@getTrendIncidentByDailyAll')->where('id', '[0-9]+')->name('admin.reports.trend-incident-by-daily-all.list');
