					...
					<div class="col-md-12">
						<div class="card m-3">
							<div class="card-header">
								<h5 class="card-title" v-show="add_record"><i class="fa fa-plus" aria-hidden="true"></i>
									Add
									New User</h5>
								<h5 class="card-title" v-show="edit_record"><i class="fas fa-edit"></i> Edit User</h5>
								<button type="button" class="btn btn-secondary btn-sm float-right"
									@click="backToList"><i class="fa fa-angle-double-left"
										aria-hidden="true"></i>&nbsp;Back to list</button>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-md-4">
									...
									<div class="coll-md-1">
										<button type="button" class="btn btn-outline-secondary btn-sm"
											@click="modalAdd"><i class="fas fa-pen"></i></button>
									</div>
									<div class="col-md-6 offset-md-1">
										...
										<div class="form-group row mb-0">
											...
											<div class="col-sm-8">
												<span v-if="user.isActive == true"
													class="badge badge-info">Active</span>
												<span v-else-if="user.isActive == 1"
													class="badge badge-danger">Active</span>
												<span v-else-if="user.isActive == 'add'"
			...
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<button type="button" class="btn btn-block btn-outline-info btn-sm"
									v-show="displayButton" @click="showPassword">Show password</button>
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								...
								<div class="input-group mb-3" v-show="displayPinCode">
									<input type="text" class="form-control" v-model="user.pass_int" maxlength="4"
										aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
									<div class="input-group-append">
						...
						<div class="form-group row">
							<label for="inputPassword3" class="col-sm-4 col-form-label">Role <span
									class="font-italic text-danger">
									*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group row">
							<label for="role" class="col-sm-4 col-form-label">Level <span
									class="font-italic text-danger">
									*</span></label>
							<div class="col-sm-8">
								<select class="custom-select" v-model="user.level">
									<option value="">Select Level</option>
									<option v-for="user_level in user_levels" :value="user_level"> {{ user_level }}
									</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<multiselect v-model="user.site_buildings" :options="site_building_list"
									:multiple="true" :close-on-select="true" placeholder="Select Sites" label="name"
									track-by="name" @input="getSiteBuildingLevels">
								</multiselect>
							</div>
						</div>
						<div class="form-group row">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary btn-sm" v-show="add_record" @click="storeUser">Add
							New
							User</button>
		...
		<div class="modal fade" id="screen-list" tabindex="-1" aria-labelledby="screen-list" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="card-body">
							<Table :dataFields="screensDataFields" :dataUrl="screenDataUrl"
								:primaryKey="screenPrimaryKey" :actionButtons="screensActionButtons"
								v-on:editButton="selectedScreen" :rowPerPage=5 ref="screensDataTable">
							</Table>
						</div>
					</div><!-- /.card-body -->
					<div class="modal-footer">
