			...
			<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
				<div class="modal-content">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<div class="custom-control custom-checkbox">
										<input class="custom-control-input" type="checkbox" id="emailNotification"
											v-model="user.emailNotification">
										<label for="emailNotification" class="custom-control-label font-normal">Send the new
											user an email about their account.</label>
									</div>
								</div>
							</div>
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary" v-show="add_record" @click="storeUser">Add New
							User</button>
						<button type="button" class="btn btn-primary" v-show="edit_record" @click="updateUser">Save
							Changes</button>
					</div>
				</div>
			</div>
...
export default {
	...
	methods: {
		...
		downloadCsv: function () {
			axios.get('/admin/users/download-csv')
				.then(response => {
