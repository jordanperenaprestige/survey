...
class SiteController extends AppBaseController implements SiteControllerInterface
{
    ...
    public function delete($id)
    {
        try {
            ...
            SiteBuilding::where('site_id', $id)->update(['deleted_at' => $date_now]);
            SiteBuildingLevel::where('site_id', $id)->update(['deleted_at' => $date_now]);
            SiteBuildingRoom::where('site_id', $id)->update(['deleted_at' => $date_now]);
